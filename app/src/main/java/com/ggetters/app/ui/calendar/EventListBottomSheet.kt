...
import com.ggetters.app.ui.adapters.EventAdapter
...
data class EventParcelable(
    ...
    companion object {
        @JvmField
        val CREATOR = object : android.os.Parcelable.Creator<EventParcelable> {
            override fun createFromParcel(parcel: android.os.Parcel): EventParcelable {
